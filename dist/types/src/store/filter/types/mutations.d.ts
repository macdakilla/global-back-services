import { Filter, Info, Items, RequestData, Sort, State, TopFilter } from "./state";
...
export interface Mutations<S = State> {
    ...
    [MutationTypes.REMOVE_KEY_FROM_REQUEST_DATA](state: S, payload: number | string): void;
    [MutationTypes.UPDATE_FILTER_BY_INDEX](state: S, payload: {
        index: number;
        item: Filter;
    }): void;
